		...
		args = {
			...
			filter = {
				...
				args = {
					...
					partyLeader = { type = "toggle", name = "Party Leader", arg = "PARTY_LEADER", order = 7 },
					instance = { type = "toggle", name = "Instance", arg = "INSTANCE_CHAT", order = 8 },
					instanceLeader = { type = "toggle", name = "Instance Leader", arg = "INSTANCE_CHAT_LEADER", order = 9 },
					raid = { type = "toggle", name = "Raid", arg = "RAID", order = 10 },
					raidLeader = { type = "toggle", name = "Raid Leader", arg = "RAID_LEADER", order = 11 },
					raidWarning = { type = "toggle", name = "Raid Warning", arg = "RAID_WARNING", order = 12 },
					battleground = { type = "toggle", name = "Battleground", arg = "BATTLEGROUND", order = 13 },
					battlegroundLeader = { type = "toggle", name = "Battleground Leader", arg = "BATTLEGROUND_LEADER", order = 14 },
					channel = { type = "toggle", name = "Channel", arg = "CHANNEL", order = 15 },
					whisper = { type = "toggle", name = "Whisper", arg = "WHISPER", order = 16 },
				},
			},
			verbose = {
				name = "Verbose Mode",
